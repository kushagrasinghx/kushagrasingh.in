    ...
    <main className='w-full min-h-[calc(100vh-100px)] flex flex-col box-border px-4 sm:px-6 md:px-[100px] py-[24px] md:py-[40px] overflow-x-hidden items-center'>
      <div className='w-full max-w-[1500px]'>
        ...
        <div className='w-full flex flex-col gap-4 md:gap-6'>
          ...
          <div className='flex items-center text-base sm:text-lg text-white/50 mt-2'>
      ...
      {deck.map((_, i) => {
        ...
        return (
          <a
            ...
            target={card.href?.startsWith('http') ? '_blank' : undefined}
            rel={card.href?.startsWith('http') ? 'noopener noreferrer' : undefined}
            className='absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 block h-[360px] w-[240px] rounded-2xl overflow-hidden border-2 border-white/20 md:shadow-[0_30px_80px_rgba(0,0,0,0.45)]'
            style={{
              transform,
              zIndex: z,
              opacity,
