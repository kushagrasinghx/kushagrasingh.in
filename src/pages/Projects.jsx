        ...
        <div className='mt-10 flex flex-col gap-12'>
          {projects.map((p, i) => (
            <div key={p.title + i}>
              ...
              <div
                className='w-full max-w-[1000px] aspect-[10/3] bg-gray-800 flex items-center justify-center overflow-hidden rounded-md border border-white/10 md:shadow-lg mb-2'
